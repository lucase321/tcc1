...
?>
    <section class="um">
        <div class="topo">
            ...
            <a href="cadocao.php"><p class="cadastrar">Clique aqui para cadastrar um animal</p></a>
        </div>
        <div class="container">
            <?php
        
        $animais = selectAllAnimals("Adoção");
        $quantidade = quantidadeAnimais("Adoção");
        $quantidadeinicial = quantidadeAnimais("Adoção");
                ...
                <div class="bloco">
                    ...
                    <div class="details">
                        ...
                        <div class="ult">
                            ...
                            <a href=<?php echo "adotar.php?id=" . $a['ani_id'] ?> ><p class="adote">Quero adotar ></p></a>
                        </div>
                    </div>
                </div>   
                ...
                <div class="bloco">
                    ...
                    <!-- <div class="details"> -->
                        ...
                        <div class="ult">
                            ...
                            <a href=""><p class="adote">Quero adotar ></p></a>
                        </div>
                    </div>
                </div>   
                <div class="bloco">
