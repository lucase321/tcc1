...
?>
    <section class="um">
        <div class="topo">
            ...
            <a href="cencontrados.php"><p class="cadastrar">Encontrou um animal? Clique aqui para publicar</p></a>
        </div>
        <div class="container">
            <?php
        
        $animais = selectAllAnimals("Encontrado");
        $quantidade = quantidadeAnimais("Encontrado");
        $quantidadeinicial = quantidadeAnimais("Encontrado");
                ...
                <div class="bloco">
                    ...
                    <div class="details">
                        ...
                        <div class="ult">
                            ...
                            <a href=<?php echo "encontrado.php?id=" . $a['ani_id'] ?> ><p class="adote">Entrar em contato ></p></a>
                        </div>
                    </div>
                </div>   
