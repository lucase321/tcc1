...
<section class="main">
    <div class="slide">
    <a href="encontrados.php"><img src="images/back.png" alt="back" class="back"></a>
        <!-- <img src="0.jpg" alt="" class="image"> -->
            <div class="box redd">
                <h1>Publicar animal encontrado</h1>
                <?php
                ...
                ?>
                <form action="php/cencontrados.php" method="POST" class="bluee" enctype="multipart/form-data">
                    <div class="selects">     
